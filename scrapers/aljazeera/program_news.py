    ...
    def scrape_method(self):
        ...
        while True:
            ...
            try:
                ...
                result.append(WebPage(unique_id=unique_id, website='aljazeera', link=self.driver.current_url, media_type='program/newsfeed', date=date_simple, title=title, content=content))
